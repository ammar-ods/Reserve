...
export const TRANSLATIONS: Record<string, { ar: string; en: string }> = {
  ...
  // Stats
  'stats.global': { ar: 'إحصائيات حجوزات موسم الصيد - 2026', en: 'Hunting season booking stats — 2026' },
  ...
  'col.checkIn': { ar: 'تاريخ الدخول', en: 'Check-in' },
  'col.checkOut': { ar: 'تاريخ الخروج', en: 'Check-out' },
  'col.period': { ar: 'الفترة', en: 'Period' },
  ...
  'booking.sameDayHint': {
    ar: 'يمكن اختيار يوم واحد للدخول والخروج، أو تمديد الحجز لعدة أيام بالنقر على تاريخ لاحق.',
    en: 'Select one day for same-day check-in and check-out, or click a later date to book multiple days.',
  },
  'booking.pickCampType': { ar: 'اختر نوع المخيم', en: 'Choose camp type' },
  'booking.noCampTypes': { ar: 'لا تتوفر أنواع مخيمات في هذه التواريخ', en: 'No camp types are free on these dates' },
  ...
  'field.visitPeriod': { ar: 'الفترة', en: 'Period' },
  'field.campType': { ar: 'نوع المخيم', en: 'Camp type' },
  'period.MORNING': { ar: 'صباح', en: 'Morning' },
  'period.EVENING': { ar: 'مساء', en: 'Evening' },
  ...
  'field.startDate': { ar: 'تاريخ الدخول', en: 'Check-in date' },
  'field.endDate': { ar: 'تاريخ الخروج', en: 'Check-out date' },
  'field.campsite': { ar: 'المخيم', en: 'Campsite' },
  'field.dailyCapacity': { ar: 'الحد اليومي', en: 'Daily cap' },
  'field.morningCap': { ar: 'حد الصباح', en: 'Morning cap' },
  'field.eveningCap': { ar: 'حد المساء', en: 'Evening cap' },
  ...
  'settings.view': { ar: 'عنوان النظام', en: 'System title' },
  'settings.accounts': { ar: 'الحسابات', en: 'Accounts' },
  'settings.accountsHint': {
    ar: 'يمكن إنشاء حسابات المشرفين والموظفين فقط.',
    en: 'Admins can create admin and host accounts only.',
  },
  'settings.accountsHintSA': {
    ar: 'يمكن إنشاء حسابات المشرف العام والمشرفين والموظفين، وحذف الحسابات الأخرى.',
    en: 'Super Admins can create Super Admin, admin, and host accounts, and can delete other accounts.',
  },
  ...
  'account.deleted': { ar: 'تم حذف الحساب', en: 'Account deleted' },
  'account.deleteConfirm': { ar: 'هل تريد حذف الحساب {name}؟', en: 'Delete account {name}?' },

  // Audit log
  'audit.title': { ar: 'سجل النظام', en: 'System log' },
  'audit.search': { ar: 'بحث بالاسم أو الجوال أو رقم الحجز...', en: 'Search by name, phone or reservation no...' },
  ...
  'error.INVALID_DATES': { ar: 'تواريخ غير صحيحة', en: 'Invalid dates' },
  'error.NOT_FOUND': { ar: 'العنصر غير موجود', en: 'Record not found' },
  'error.MISSING_PERIOD': { ar: 'الرجاء اختيار الفترة (صباح أو مساء)', en: 'Please choose morning or evening' },
  'error.MISSING_CAMP_TYPE': { ar: 'الرجاء اختيار نوع المخيم', en: 'Please choose a camp type' },
  'error.CAMP_TYPE_TAKEN': { ar: 'نوع المخيم محجوز في تاريخ {date}', en: 'That camp type is already booked on {date}' },
  'error.CANNOT_DELETE_SELF': { ar: 'لا يمكن حذف حسابك الحالي', en: 'You cannot delete your own account' },
  'error.LAST_SUPER_ADMIN': { ar: 'لا يمكن حذف المشرف العام الأخير', en: 'Cannot delete the last Super Admin' },
  'error.GENERIC': { ar: 'حدث خطأ غير متوقع', en: 'Something went wrong' },

  // Misc
  'common.currency': { ar: 'د.إ', en: 'AED' },
  'common.none': { ar: '—', en: '—' },
